...
CONF_ESTIMATE_FROM_WEATHER = "estimate_from_weather"
...
SENSOR_FORECAST_SLOT_24H = "forecast_slot_24h"
SENSOR_FORECAST_SLOT_48H = "forecast_slot_48h"
SENSOR_FORECAST_SLOT_3D = "forecast_slot_3d"

FORECAST_SLOTS: tuple[tuple[str, int], ...] = (
    (SENSOR_FORECAST_SLOT_24H, 24),
    (SENSOR_FORECAST_SLOT_48H, 48),
    (SENSOR_FORECAST_SLOT_3D, 72),
)
